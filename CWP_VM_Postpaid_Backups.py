...
Dag_Name = "CWP_VM_Postpaid_Backups"
strName = "Panama - Backups Postpaid"
...
with DAG(f'{Dag_Name}',
     ...
     guard_dna = SSHOperator(
        task_id=f"guard_dna_{Dag_Name}",
        command= "/bin/bash /lla/dags/bash_codes/ejecuta_sas.sh /saswork /sasconfig/Lev1/SASApp/SASEnvironment/SASCode/Jobs/jb_RES_GA_DNA_POSTPAID_BASE_SNAP.sas /lla/logs/sas/",
        ssh_hook = sshHook,
        dag=dag
      )    
     ...
     bkp_dna = SSHOperator(
        ...
        command= "/bin/bash /lla/dags/bash_codes/ejecuta_sas.sh /saswork /sasconfig/Lev1/SASApp/SASEnvironment/SASCode/Jobs/JB_BK_DNA_POSTPAID_BASE_SNAP.sas /lla/logs/sas/",
        ssh_hook = sshHook,
        dag=dag
      )    
     ...
     bkp_rtng = SSHOperator(
        ...
        command= "/bin/bash /lla/dags/bash_codes/ejecuta_sas.sh /saswork /sasconfig/Lev1/SASApp/SASEnvironment/SASCode/Jobs/JB_BK_PROD_RTNG_PLN_POS.sas /lla/logs/sas/",
        ssh_hook = sshHook,
        dag=dag
      )    
